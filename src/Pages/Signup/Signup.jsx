  ...
  return (
    <div className="mt-[40px] md:mt-[277px]">
      ...
      <div className="px-4 w-[100%] h-[100px]">
        <div className="flex gap-[12px] border-[#E4E7EC] border rounded-xl  p-[20px]">
        ...
        <div className="flex gap-[12px] border-[#E4E7EC] border rounded-xl p-[20px] mt-[30px]">
          ...
          <input
            type="checkbox"
            className="border-solid border-[2px] border-[#D0D5DD] rounded size-[16px] mt-[15px] md:ml-[120px] cursor-pointer"
          />
        </div>
